...
unsigned char nv_ram_buffer[0x1000];

#define FLASH_NV_COUNTERS_AREA_OFFSET  (nv_ram_buffer)
/* NV Counters definitions */
#define TFM_NV_COUNTERS_AREA_ADDR    FLASH_NV_COUNTERS_AREA_OFFSET
#define TFM_NV_COUNTERS_AREA_SIZE    0x10 //FLASH_NV_COUNTERS_AREA_SIZE
#define TFM_NV_COUNTERS_SECTOR_ADDR  FLASH_NV_COUNTERS_AREA_OFFSET
#define TFM_NV_COUNTERS_SECTOR_SIZE  0x1000 //FLASH_AREA_IMAGE_SECTOR_SIZE
...
#else
    memcpy(sector_data, TFM_NV_COUNTERS_SECTOR_ADDR, TFM_NV_COUNTERS_SECTOR_SIZE);
#endif
...
#else
    memcpy(TFM_NV_COUNTERS_SECTOR_ADDR, sector_data, TFM_NV_COUNTERS_SECTOR_SIZE);
#endif
    return TFM_PLAT_ERR_SUCCESS;
}
...
#else
    memcpy(val, flash_addr, NV_COUNTER_SIZE);
#endif
    return TFM_PLAT_ERR_SUCCESS;
}
